      ...
      <div className="relative">
        ...
        <div className="mb-5">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <h2 className="text-white font-bold text-lg leading-tight">DSO Login</h2>
              <span className="text-[#00C2FF] text-xs font-medium tracking-wider">FIELD SALES PORTAL</span>
            </div>
          </div>

          <div className="flex items-center gap-2">
            <span className="px-3 py-1 bg-[#0057FF]/10 border border-[#0057FF]/20 rounded-full text-[#00C2FF] text-xs font-semibold flex items-center gap-1.5">
              <Smartphone size={12} />
              {franchiseId}
            </span>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-3.5 bg-white/5 border border-white/10 rounded-xl text-white placeholder:text-white/25 focus:outline-none focus:border-[#00C2FF]/50 focus:ring-2 focus:ring-[#00C2FF]/10 transition-all text-sm"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-12 py-3.5 bg-white/5 border border-white/10 rounded-xl text-white placeholder:text-white/25 focus:outline-none focus:border-[#00C2FF]/50 focus:ring-2 focus:ring-[#00C2FF]/10 transition-all text-sm"
              />
              <button
                type="button"
