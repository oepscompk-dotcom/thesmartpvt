        ...
        {step === "select" ? (
          <>
            ...
            <div className="mt-4 flex flex-wrap justify-center gap-2">
              ...
              {["NRWP-1217", "LHR-1005", "KHI-2201"].map((id) => (
                <button key={id} onClick={() => { setFranchiseId(id); setError(""); }} className="text-[#00C8FF]/50 text-xs font-mono hover:text-[#00C8FF] transition-colors">
                  {id}
                </button>
              ))}
            </div>
          ...
          <>
            ...
            <div className="flex gap-3">
              ...
              <button onClick={() => onVerified(verifiedId)} className="flex-1 py-3 bg-gradient-to-r from-[#2D28CD] to-[#00C8FF] text-white text-sm font-bold rounded-xl hover:shadow-[0_0_25px_rgba(45,40,205,0.3)] transition-all hover:scale-[1.02]">
                Continue to Login
              </button>
            </div>
          </>
