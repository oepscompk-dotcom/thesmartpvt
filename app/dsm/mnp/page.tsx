...
import {
  ArrowLeftRight, X, ArrowRight, ArrowLeft, Trash2, Search, CheckCircle,
} from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <PageHeader
          breadcrumb={[{ label: "DSM" }, { label: "Activations" }, { label: "MNP" }]}
              ...
              {filtered.length === 0 ? (
                <tr>
                  <td colSpan={11} className="px-6 py-12 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">No MNP activations found</p>
                  </td>
                </tr>
              ) : (
                filtered.map((a, idx) => (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="w-full max-w-lg bg-white rounded-2xl border border-slate-200 mx-4 shadow-2xl">
            <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
              <h3 className="text-lg font-bold text-foreground">New MNP Activation</h3>
            ...
            <div className="px-6 py-4 space-y-4 max-h-[60vh] overflow-y-auto">
                ...
                <div className="rounded-xl border border-blue-200 bg-blue-50 p-4">
                  ...
                  <div className="grid grid-cols-3 gap-3 text-sm">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-foreground">{form.newNetwork}</p>
                    </div>
                    <div>
              ...
              <div>
                <label className="block mb-1 text-xs font-medium text-muted-foreground">Current Network</label>
              ...
              <div>
                <label className="block mb-1 text-xs font-medium text-muted-foreground">New Network (must differ)</label>
                <Select
                  name="newNetwork"
                  value={form.newNetwork}
                  disabled
