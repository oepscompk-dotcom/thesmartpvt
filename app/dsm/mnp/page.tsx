...
import { ArrowRightLeft, User, Phone, MessageSquare, CheckCircle2, Tag, ArrowLeft, ChevronRight, Signal } from "lucide-react";
...
export default function MNPProcess() {
  ...
  return (
    <div className="space-y-6">
      {showSuccess && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
          <div className="bg-white rounded-2xl p-8 shadow-2xl text-center max-w-sm mx-4 animate-bounce">
            ...
            <h3 className="text-gray-900 font-bold text-xl mb-2">MNP Submitted!</h3>
      ...
      <div className="flex items-center gap-3 mb-2">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">MNP Process</h1>
          <p className="text-gray-500 text-sm">Mobile Number Portability request</p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-2xl p-6 border border-gray-100">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Additional notes about this MNP request..."
              rows={3}
