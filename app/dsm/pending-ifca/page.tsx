  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        {/* Header */}
        <div className="rounded-2xl p-6 text-white" style={{ backgroundColor: "#0057FF" }}>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-100 mt-1">
                  Data &amp; internet verification for activated SIMs
                </p>
                {/* Progress Indicator */}
        ...
        {filteredPending.length === 0 ? (
          <div className="bg-white rounded-2xl border border-gray-100 p-12 text-center shadow-sm">
            ...
            <p className="text-gray-500 font-medium text-lg">
              {pending.length === 0
                ? "All IFCA verifications completed"
                : "No results found"}
            </p>
              ...
              <div className="p-3 rounded-xl border border-gray-200 mb-4 bg-gray-50">
                <div className="grid grid-cols-2 gap-2 text-xs">
                  <div>
                    ...
                    <span className="font-medium text-gray-800">{selected.simNumber}</span>
                  </div>
                  <div>
                    <span className="text-gray-500">Network:</span>{" "}
                    <span className="font-medium text-gray-800">{selected.network}</span>
                  </div>
                  <div>
                    <span className="text-gray-500">CNIC:</span>{" "}
                    <span className="font-medium text-gray-800">{selected.customerCNIC}</span>
                  </div>
                  <div>
